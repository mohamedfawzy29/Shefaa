...
import {
    ...
    Activity, Star, Lock, ShieldAlert
} from "lucide-react";
import { resetPasswordSchema, type ResetPasswordFormData } from "../validation/loginSchema";
...
export default function ResetPasswordPage() {
    ...
    const state = location.state as { identifier?: string; resetToken?: string } | null;
        ...
        return (
            <div className="flex min-h-screen items-center justify-center bg-[#F8FAFC] dark:bg-[#020617] !p-4 transition-colors duration-300">
                <div className="w-full max-w-md rounded-[32px] bg-white dark:bg-[#0F172A] !p-10 shadow-[0_32px_80px_-12px_rgba(0,0,0,0.18)] dark:shadow-[0_32px_80px_-12px_rgba(0,0,0,0.7)] text-center border border-transparent dark:border-slate-800">
                    ...
                    <h2 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-3">Invalid Session</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-8">
                        Your reset session has expired or is invalid. Please start over from Forgot Password.
                    </p>
                    <Link
                        to="/forgot-password"
                ...
                <section className="flex w-full flex-col justify-center bg-white dark:bg-[#0F172A] !px-10 !py-14 sm:!px-14 lg:w-[45%]">
                    ...
                    <div className="!mb-9 text-center">
                        ...
                        <p className="mt-2 text-[15px] text-slate-500 dark:text-slate-400">
                            Create your new password securely below.
                        </p>
                    </div>
                            ...
                            <Field label="New Password" error={errors.newPassword?.message}>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="••••••••"
                                        className={`${inputCls(!!errors.newPassword)} !pl-11`}
                                    />
                                </div>
                            </Field>
                ...
                <section className="relative hidden lg:flex lg:w-[55%] flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 !px-12 !py-14">
                    ...
                    <div className="relative text-center mb-10">
                        ...
                        <p className="mt-4 text-[15px] leading-relaxed text-blue-100/75 max-w-xs mx-auto">
                            Ensure it meets standard security requirements. Keep your credentials safe and personal.
                        </p>
                    </div>

                    {/* Stats row */}
                    <div className="relative grid grid-cols-3 gap-3 w-full max-w-sm">
                        <Stat icon={Users} value="SSL" label="Encryption" />
                        <Stat icon={Activity} value="Instantly" label="Updated" />
                        <Stat icon={Star} value="100%" label="Safe storage" />
                    </div>
